...
<table width="100%">
  <tr>
    <td align="center" width="25%">
      <img src="./components/icon-red-team.svg" width="48" alt="Red Team Operations" />
      <br />
      <strong>Red Team & Offense</strong>
    </td>
    <td align="center" width="25%">
      <img src="./components/icon-blue-team.svg" width="48" alt="Blue Team Tactics" />
      <br />
      <strong>Blue Team & Defense</strong>
    </td>
    <td align="center" width="25%">
      <img src="./components/icon-labs.svg" width="48" alt="Vulnerability Labs" />
      <br />
      <strong>Vulnerability Labs</strong>
    </td>
    <td align="center" width="25%">
      <img src="./components/icon-scripts.svg" width="48" alt="Scripts & PoCs" />
      <br />
